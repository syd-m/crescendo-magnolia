...
This package contains:
   ...
   Magnolia Core 5.4.9
   magnolia-empty-webapp 5.4.9
   magnolia-empty-webapp 5.4.9
   Magnolia Internationalization Framework 5.4.9
   Magnolia Imaging Support Module 3.2.7
   Magnolia JAAS 5.4.9
   Magnolia Commenting Module 2.3.2
   Magnolia Form Module 2.3.6
   magnolia-module-forum 3.5
   Google Sitemap Module 2.3.4
   magnolia-module-groovy 2.4.6
   Magnolia Imaging Module 3.2.7
   Magnolia Legacy UI 5.3.3
   magnolia-module-mail 5.3
   magnolia-module-rssaggregator 2.4.1
   Magnolia Rendering 5.4.9
   Magnolia Templating 5.4.9
   Magnolia Templating for JSP 5.4.9
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.4.9.html
